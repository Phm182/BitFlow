...
<?php if ($authenticatedUser): ?>
    <header class="admin-topbar">
        <a class="admin-brand" href="<?= admin_h(admin_url('dashboard.php')) ?>">
            <img class="admin-brand__logo" src="<?= admin_h(rtrim(dirname(admin_base_url()), '/\\') . '/img/logo-bitflow-hd.png') ?>" alt="BitFlow">
        ...
        <nav class="admin-nav" id="admin-nav" data-menu>
            ...
            <a href="<?= admin_h(rtrim(dirname(admin_base_url()), '/\\') . '/inicio.php') ?>" target="_blank" rel="noopener">Ver sitio</a>
